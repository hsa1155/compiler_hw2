...
public class myparserLexer extends Lexer {
	...
	public final void mT__63() throws RecognitionException {
		try {
			int _type = T__63;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:19:7: ( 'else' )
			// myparser.g:19:9: 'else'
			{
			match("else"); 
	...
	public final void mT__65() throws RecognitionException {
		try {
			int _type = T__65;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:21:7: ( 'return' )
			// myparser.g:21:9: 'return'
			{
			match("return"); 
	...
	public final void mBASIC_TYPE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:183:5: ( 'short' | 'int' | 'long' | 'double' | 'float' | 'char' | 'void' )
			int alt1=7;
			switch ( input.LA(1) ) {
			case 's':
				{
	...
	public final void mSIGN() throws RecognitionException {
		try {
			int _type = SIGN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:193:5: ( 'signed' | 'unsigned' )
			int alt2=2;
	...
	public final void mEXTEND_TYPE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:198:5: ( 'struct' | 'enum' | 'union' )
			int alt3=3;
			switch ( input.LA(1) ) {
			case 's':
				{
	...
	public final void mTYPEDEF() throws RecognitionException {
		try {
			int _type = TYPEDEF;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:204:5: ( 'typedef' )
			// myparser.g:204:6: 'typedef'
			{
			match("typedef"); 
	...
	public final void mTYPE_MODIFIER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:208:5: ( 'const' | 'restrict' | 'volatile' )
			int alt4=3;
			switch ( input.LA(1) ) {
			case 'c':
				{
	...
	public final void mNULL_PTR() throws RecognitionException {
		try {
			int _type = NULL_PTR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:214:5: ( 'NULL' )
			// myparser.g:214:6: 'NULL'
			{
			match("NULL"); 
	...
	public final void mSTORAGE_CLASS_SPECIFIER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:218:5: ( 'extern' | 'static' | 'auto' | 'register' )
			int alt5=4;
			switch ( input.LA(1) ) {
			case 'e':
				{
	...
	public final void mINLINE() throws RecognitionException {
		try {
			int _type = INLINE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:225:5: ( 'inline' )
			// myparser.g:225:6: 'inline'
			{
			match("inline"); 
	...
	public final void mFLOW_CONTROL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:229:5: ( 'if' | 'else' | 'switch' | 'case' | 'default' )
			int alt6=5;
			switch ( input.LA(1) ) {
			case 'i':
				{
	...
	public final void mFOR() throws RecognitionException {
		try {
			int _type = FOR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:239:2: ( 'for' )
			// myparser.g:239:3: 'for'
			{
			match("for"); 
	...
	public final void mWHILE() throws RecognitionException {
		try {
			int _type = WHILE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:243:2: ( 'while' )
			// myparser.g:243:3: 'while'
			{
			match("while"); 
	...
	public final void mLOOP_CTRL() throws RecognitionException {
		try {
			int _type = LOOP_CTRL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:251:2: ( 'break' | 'continue' )
			int alt7=2;
	...
	public final void mSIZEOF() throws RecognitionException {
		try {
			int _type = SIZEOF;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:261:5: ( 'sizeof' )
			// myparser.g:261:6: 'sizeof'
			{
			match("sizeof"); 
	...
	public final void mLITERAL_STRING() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:266:5: ( '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"' )
			// myparser.g:266:6: '\"' ( EscapeSequence |~ ( '\\\\' | '\"' ) )* '\"'
			{
			match('\"'); 
			// myparser.g:266:10: ( EscapeSequence |~ ( '\\\\' | '\"' ) )*
			loop9:
			while (true) {
				int alt9=3;
				...
				switch (alt9) {
				case 1 :
					// myparser.g:266:12: EscapeSequence
					{
					mEscapeSequence(); 
	...
	public final void mLITERAL_CHAR() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:270:5: ( '\\'' (~ ( '\\'' ) | EscapeSequence ) '\\'' )
			// myparser.g:270:6: '\\'' (~ ( '\\'' ) | EscapeSequence ) '\\''
			{
			match('\''); 
			// myparser.g:270:11: (~ ( '\\'' ) | EscapeSequence )
			int alt10=2;
			...
			switch (alt10) {
				case 1 :
					...
					break;
				case 2 :
					// myparser.g:270:20: EscapeSequence
					{
					mEscapeSequence(); 
	...
	public final void mDECIMAL_INT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:274:5: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
			// myparser.g:274:7: ( '0' | '1' .. '9' ( '0' .. '9' )* )
			{
			// myparser.g:274:7: ( '0' | '1' .. '9' ( '0' .. '9' )* )
			int alt12=2;
			...
			switch (alt12) {
				case 1 :
					...
					break;
				case 2 :
					// myparser.g:274:14: '1' .. '9' ( '0' .. '9' )*
					{
					matchRange('1','9'); 
					// myparser.g:274:23: ( '0' .. '9' )*
					loop11:
					while (true) {
						int alt11=2;
	...
	public final void mHEX_INT() throws RecognitionException {
		try {
			int _type = HEX_INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:278:5: ( '0' ( 'x' | 'X' ) ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+ )
			// myparser.g:278:7: '0' ( 'x' | 'X' ) ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )+
			{
			match('0'); 
	...
	public final void mOCTAL_INT() throws RecognitionException {
		try {
			int _type = OCTAL_INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:282:5: ( '0' ( '0' .. '7' )+ )
			// myparser.g:282:6: '0' ( '0' .. '7' )+
			{
			match('0'); 
			// myparser.g:282:10: ( '0' .. '7' )+
			int cnt14=0;
			loop14:
			while (true) {
				int alt14=2;
	...
	public final void mFLOAT() throws RecognitionException {
		try {
			int _type = FLOAT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:286:5: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ( 'f' | 'F' | 'd' | 'D' )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ( 'f' | 'F' | 'd' | 'D' )? | ( '0' .. '9' )+ ( ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) | ( 'f' | 'F' | 'd' | 'D' ) | ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) ( 'f' | 'F' | 'd' | 'D' ) ) )
			int alt32=3;
			alt32 = dfa32.predict(input);
			switch (alt32) {
				case 1 :
					// myparser.g:286:6: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ( 'f' | 'F' | 'd' | 'D' )?
					{
					// myparser.g:286:6: ( '0' .. '9' )+
					int cnt15=0;
					loop15:
					while (true) {
						int alt15=2;
					...
					break;
				case 2 :
					// myparser.g:287:6: '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ( 'f' | 'F' | 'd' | 'D' )?
					{
					match('.'); 
					// myparser.g:287:10: ( '0' .. '9' )+
					int cnt21=0;
					loop21:
					while (true) {
						int alt21=2;
					...
					break;
				case 3 :
					// myparser.g:288:6: ( '0' .. '9' )+ ( ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) | ( 'f' | 'F' | 'd' | 'D' ) | ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) ( 'f' | 'F' | 'd' | 'D' ) )
					{
					// myparser.g:288:6: ( '0' .. '9' )+
					int cnt26=0;
					loop26:
					while (true) {
						int alt26=2;
					...
					// myparser.g:288:18: ( ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) | ( 'f' | 'F' | 'd' | 'D' ) | ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) ( 'f' | 'F' | 'd' | 'D' ) )
					int alt31=3;
					alt31 = dfa31.predict(input);
					switch (alt31) {
						case 1 :
							// myparser.g:288:21: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
							{
							// myparser.g:288:21: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
							// myparser.g:288:22: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
							{
							if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
								input.consume();
							}
						...
						case 2 :
							...
							break;
						case 3 :
							// myparser.g:288:78: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) ( 'f' | 'F' | 'd' | 'D' )
							{
							// myparser.g:288:78: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
							// myparser.g:288:79: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
							{
							if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
								input.consume();
							}
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:403:2: ( LETTER ( LETTER | DIGIT )* )
			// myparser.g:403:4: LETTER ( LETTER | DIGIT )*
			{
			mLETTER(); 

			// myparser.g:403:11: ( LETTER | DIGIT )*
			loop37:
			while (true) {
				int alt37=2;
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// myparser.g:413:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// myparser.g:413:9: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// myparser.g:413:14: ( options {greedy=false; } : . )*
			loop38:
			while (true) {
				int alt38=2;
	...
	public final void mEscapeSequence() throws RecognitionException {
		try {
			// myparser.g:429:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | OctalEscape )
			int alt45=2;
	...
	public final void mOctalEscape() throws RecognitionException {
		try {
			// myparser.g:435:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
			int alt46=3;
	...
	public void mTokens() throws RecognitionException {
		...
		switch (alt47) {
			...
			case 22 :
				...
				break;
			case 23 :
				// myparser.g:1:154: TYPE_MODIFIER
				{
				mTYPE_MODIFIER(); 
			...
			case 24 :
				...
				break;
			case 25 :
				// myparser.g:1:177: STORAGE_CLASS_SPECIFIER
				{
			...
			case 33 :
				...
				break;
			case 34 :
				// myparser.g:1:256: LITERAL_STRING
				{
				mLITERAL_STRING(); 
			...
			case 39 :
				...
				break;
			case 40 :
				// myparser.g:1:320: PARENTHESES_LEFT
				{
				mPARENTHESES_LEFT(); 
				...
				break;
			case 41 :
				// myparser.g:1:337: PARENTHESES_RIGHT
				{
				mPARENTHESES_RIGHT(); 
				...
				break;
			case 42 :
				// myparser.g:1:355: SQUARE_BRACKETS_LEFT
				{
				...
				break;
			case 43 :
				// myparser.g:1:376: SQUARE_BRACKETS_RIGHT
				{
				...
				break;
			case 44 :
				// myparser.g:1:398: CURLY_BRACKETS_LEFT
				{
				...
				break;
			case 45 :
				// myparser.g:1:418: CURLY_BRACKETS_RIGHT
				{
			...
			case 51 :
				...
				break;
			case 52 :
				// myparser.g:1:481: LOGICAL_EQUALITY_OPERATOR
				{
				...
				break;
			case 53 :
				// myparser.g:1:507: SHIFT_OPERATOR
				{
				mSHIFT_OPERATOR(); 
				...
				break;
			case 54 :
				// myparser.g:1:522: COMPARISON_OPERATOR
				{
				...
				break;
			case 55 :
				// myparser.g:1:542: ASSIGN_OPERATOR
				{
				mASSIGN_OPERATOR(); 
